...
KRX(한국거래소) 상장규정·공시규정·매매거래제도 등 규정 **해설 자료 660건**
(regulation.krx.co.kr 194건 + listing.krx.co.kr 60건 + KIND 게시 「코스닥시장 공시·상장관리 해설」
PDF 406페이지)을 검색·조회하는 MCP 서버입니다.

규정 해설 페이지(254건)에는 없는 상장관리업무 세부 지정요건(예: 투자주의환기종목 정기지정
...
├── data/krx_pages.json  # 크롤링된 660건 데이터 (규정해설 254 + KIND PDF 406페이지)
